 ...
 *  - O cache normalizado da Assertiva é isolado por empresa e tem TTL padrão
 *    de 3 meses. O cache legado da Lemit foi desativado porque suas tabelas não
 *    possuíam tenant e colidiam com a tabela `empresas` da plataforma.
 *
 * Toda resposta carrega `fonte`: local_db_assertiva | api_lemit | api_assertiva.
 */
