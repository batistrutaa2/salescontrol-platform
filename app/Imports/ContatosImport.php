...
class ContatosImport implements ToModel, SkipsEmptyRows,  WithHeadingRow, WithStartRow
{
  ...
  public function model(array $row)
  {
    return new Contatos([
      ...
      'telefone1' => Helpers::cleanSpecialCharactersTelefone($row['contato_1']),
      'telefone2' => Helpers::cleanSpecialCharactersTelefone($row['contato_2']),
      'telefone3' => Helpers::cleanSpecialCharactersTelefone($row['contato_3']),
      'email' => $row['email'],
      'idades' => $row['idades'],
