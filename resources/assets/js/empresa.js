...
(function () {
  ...
  submitButton.addEventListener('click', function (event) {
    fv.validate().then(function (status) {
      if (status === 'Valid') {
        const formData = {
          nome_fantasia: document.querySelector('[name="customerName"]').value,
          cpf_cnpj: document.querySelector('[name="customerCnpj"]').value,
          telefone: document.querySelector('[name="customerContact"]').value,
