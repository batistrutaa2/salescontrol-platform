    ...
    @section('content')
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#discardModal" id="js-descartar-cliente">
                                Descartar contato
                            </button>
                                    ...
                                    <div class="col">
                                        <div class="form-floating form-floating-outline">
                                            <input type="email" class="form-control" id="ecommerce-product-sku"
                                                {{ $editingPermission == false ? 'disabled' : '' }}
                                                value="{{ $client->email }}" placeholder="admin@admin.com.br"
                                                name="email" aria-label="Email Cliente">
                            ...
                            <div class="card-body">
                                <div class="accordion mt-5" id="collapsibleSection">
                                    @foreach ($dependentes as $index => $dependente)
                                        ...
                                        {{-- Form de exclusão oculto (referenciado pelo botão do cabeçalho) --}}
                                        <form id="delete-dependent-{{ $index }}" method="POST"
                                            action="{{ route('comercial.deletar.depedente') }}" class="d-none">
                                            @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="text-center mb-6">
                            ...
                            <p class="address-subtitle">Informe os dados da empresa e os titulares da apólice.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('comercial.createSale') }}" class="row g-5 create-sale">
                            ...
                            <div class="col-12">
                                ...
                                <small class="text-muted">Informações gerais do contrato (empresa).</small>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="telefone1" name="telefone1"
                                        class="form-control mask-telefone" placeholder="(11) 91234-5678" />
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="telefone2" name="telefone2"
                                        class="form-control mask-telefone" placeholder="(11) 93456-7890" />
                            ...
                            {{-- B2: Apólice (Operadora única) --}}
                            <div class="col-12">
                                <hr class="my-2">
                                <h6 class="mb-1">Apólice</h6>
                                <small class="text-muted">Escolha a operadora para esta apólice.</small>
                            </div>
                                ...
                                <div class="form-floating form-floating-outline">
                                    <select id="operadora" name="operadora_id" class="form-select" required>
                                        ...
                                        @foreach ($operadoras as $op)
                                            <option value="{{ $op->id }}"
                                                data-nome="{{ strtoupper($op->nome) }}">
                                                {{ strtoupper($op->nome) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" min="1" value="1" id="qtd_titulares"
                                        class="form-control" placeholder="1" />
                                    <label for="qtd_titulares">Quantidade de titulares</label>
                                </div>
                            </div>

                            <div class="col-12" id="titulares-container">
                                {{-- grupos dinâmicos de titulares renderizados via JS --}}
                            </div>

                            {{-- Opcional: valores/observações --}}
                            <div class="col-12 col-md-12">
                                <div class="form-floating form-floating-outline">
        ...
        <div class="modal fade" id="scheduleModal" tabindex="-1" aria-labelledby="sheduleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p><strong>Tipo:</strong> <span id="tipoEmpresa" class="text-muted"></span>
                                            </p>
                                            <p><strong>Situação:</strong> <span id="situacaoEmpresa"
                                                    class="text-muted"></span></p>
                                            <p><strong>CNAE:</strong> <span id="cnaeEmpresa" class="text-muted"></span>
                                            </p>
                            ...
                            <div id="dadosPessoa" class="d-none">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Nome:</strong> <span id="nome" class="text-muted"></span>
                                                </p>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p><strong>Situação CPF:</strong> <span id="situacaoCpf"
                                                        class="text-muted"></span></p>
                                                <p><strong>Renda:</strong> <span id="renda" class="text-muted"></span>
                                                </p>
                                                <p><strong>Ocupação:</strong> <span id="ocupacao"
