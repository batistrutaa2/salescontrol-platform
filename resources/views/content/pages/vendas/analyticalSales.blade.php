...
@section('title', 'Relatório de Vendas Analítico')

@section('vendor-style')
    @vite([
        'resources/assets/vendor/libs/apex-charts/apex-charts.scss',
        'resources/assets/vendor/libs/flatpickr/flatpickr.scss',
        'resources/assets/vendor/scss/pages/vendas-analitico.scss'
    ])
@endsection
...
@section('content')
<div class="vendas-analitico-wrapper">
    {{-- Header Section --}}
    <div class="va-header">
        <div class="header-content">
            <div class="header-text">
                <span class="greeting-label">Relatorios</span>
                <h1 class="main-title">Vendas Analitico</h1>
                <p class="subtitle">Visao completa do desempenho comercial com metricas e analises detalhadas</p>
            </div>
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card kpi-success">
            ...
            <div class="kpi-content">
                ...
                <h2 class="kpi-value" id="valorImplantado">R$ 0,00</h2>
                <div class="kpi-trend trend-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/>
                        <polyline points="17 6 23 6 23 12"/>
        ...
        <div class="filter-body" id="filterBody">
            <form id="filtrosForm">
                ...
                <div class="filter-actions">
                    ...
                    <button type="button" class="btn-dash btn-success" id="exportarBtn">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="charts-section">
        <div class="chart-row">
            <div class="chart-card chart-half">
                <div class="chart-header">
                    <div class="chart-title-group">
                        ...
                        <span class="chart-subtitle">Valor e quantidade por mes</span>
                    </div>
            ...
            <div class="chart-card chart-half">
                ...
                <div class="chart-body">
                    <div id="vendasPorVendedorChart"></div>
                </div>
            </div>
        </div>
        ...
        <div class="chart-row">
            <div class="chart-card chart-half">
                <div class="chart-header">
                    <div class="chart-title-group">
                        <h3 class="chart-title">Vendas por Operadora</h3>
                        <span class="chart-subtitle">Distribuicao por parceiro</span>
                    </div>
                </div>
                <div class="chart-body">
                    <div id="vendasPorOperadoraChart"></div>
                </div>
            </div>
            ...
            <div class="chart-card chart-half">
                <div class="chart-header">
                    <div class="chart-title-group">
                        ...
                        <span class="chart-subtitle">Planos mais vendidos</span>
                    </div>
                </div>
                <div class="chart-body">
                    <div id="vendasPorPlanoChart"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="table-card">
            <div class="table-header">
                <div class="table-title-group">
                    ...
                    <div>
                        <h3 class="table-title">Lista de Vendas</h3>
                        <span class="table-subtitle">Detalhamento dos contratos</span>
                    </div>
                </div>
            ...
            <div class="table-body">
                <table class="custom-table" id="vendasTable">
                    <thead>
                        <tr>
                            <th>Data</th>
                            <th>Contrato</th>
            ...
            <nav class="va-pagination" id="paginacao"></nav>
        </div>
    </div>
</div>
