                        ...
                        <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-4 pb-sm-0">
                            <div>
                                ...
                                <h4 class="mb-1 js--vendasCadastradas">R$
                                    0</h4>
                                <p class="mb-0"><span class="me-2 js--quantidadeCadastrada">0
                                        Contratos</span></p>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-4 pb-sm-0">
                            <div>
                                ...
                                <h4 class="mb-1 js--vendasImplantadas">R$
                                    0</h4>
                                <p class="mb-0"><span class="me-2 js--quantidadeImplantada">0
                                        Contratos</span></p>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-start border-end pb-4 pb-sm-0 card-widget-3">
                            <div>
                                ...
                                <h4 class="mb-1  js--vendasEstornada">R$
                                    0</h4>
                                <p class="mb-0   js--quantidadeEstornada">0
                                    Contratos</p>
                            </div>
                            <div class="avatar me-sm-6">
                                <span class="avatar-initial rounded bg-label-secondary text-heading">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h4 class="mb-1 js--conversaoMensal">% 0</h4>
                                <p class="mb-0"><span class="me-2 js--quantidadeContatos">0
                                        Contratos</span></p>
                            </div>
                            <div class="avatar">
                                <span class="avatar-initial rounded bg-label-secondary text-heading">
