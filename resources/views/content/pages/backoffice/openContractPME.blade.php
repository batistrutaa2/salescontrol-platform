...
@section('content')
    ...
    <div class="pme-contract-wrapper">
        ...
        <div class="pme-header">
            ...
            <div class="pme-header-stats">
                ...
                <div class="stat-item stat-demandas-pme" id="stat-demandas-toggle" role="button" title="Expandir demandas">
                    <span class="stat-value" id="demandas-stat-count">0</span>
        ...
        <div class="demandas-panel demandas-panel-pme">
    ...
    <div class="modal fade" id="modalAddDemanda" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-demanda-pme">
                <div class="modal-header">
                    <div class="modal-demanda-icon">
                    ...
                    <div>
                        ...
                        <p class="modal-subtitle-text">Cadastre uma tarefa operacional para este contrato</p>
                    </div>
                    <button type="button" class="btn-close-demanda-modal" data-bs-dismiss="modal" aria-label="Fechar">
                ...
                <form id="form-demanda">
                    ...
                    <div class="modal-body">
                        <div class="demanda-field">
                            ...
                            <select name="tipo" id="demanda_tipo" class="demanda-input" required>
                        ...
                        <div class="demanda-field">
                            ...
                            <input type="text" name="titulo" id="demanda_titulo" class="demanda-input" placeholder="Título da demanda" required>
                            <span class="demanda-hint">Preenchido automaticamente pelo tipo ou digite livremente</span>
                        </div>
                        <div class="demanda-field">
                            <label>Descrição <span class="optional">(opcional)</span></label>
                            <textarea name="descricao" id="demanda_descricao" class="demanda-input" rows="3" placeholder="Detalhes adicionais..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn-save-demanda" id="btn-save-demanda">
                            ...
                            <span id="btn-save-demanda-text">Salvar</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="modalDeleteDemanda" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content modal-delete-demanda-pme">
