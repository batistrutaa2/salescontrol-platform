                        ...
                        <div class="titular-body">
                            <div class="info-list">
                                ...
                                <div class="info-row">
                                    ...
                                    <span class="info-value">{{ $titular->data_nascimento->format('d/m/Y') }} <span>({{ $calcularIdade($titular->data_nascimento) }} anos)</span></span>
                                </div>
                                @endif
                                @if($titular->email)
                                <div class="info-row">
                                ...
                                <div class="info-row">
                                    ...
                                    <span class="info-value info-highlight">{{ strtoupper($titular->plano->nome) }}@if($titular->plano->acomodacao) <span>| {{ $titular->plano->acomodacao }}</span>@endif</span>
                                </div>
                                @endif
                            ...
                            <div class="dependente-card">
                                ...
                                <div class="dep-body">
                                    <div class="info-list info-list-compact">
                                        ...
                                        <div class="info-row">
                                            <span class="info-label">Data Nasc.</span>
                                            <span class="info-value">{{ $dep->data_nascimento->format('d/m/Y') }} <span>({{ $calcularIdade($dep->data_nascimento) }} anos)</span></span>
                                        </div>
                                        @endif
                                        @if($dep->email)
                                        <div class="info-row">
                                        ...
                                        <div class="info-row">
                                            <span class="info-label">Plano</span>
                                            <span class="info-value info-highlight">{{ strtoupper($dep->plano->nome) }}@if($dep->plano->acomodacao) <span>| {{ $dep->plano->acomodacao }}</span>@endif</span>
                                        </div>
                                        @endif
