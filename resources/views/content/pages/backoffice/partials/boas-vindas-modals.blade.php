    ...
    <div class="modal-dialog modal-dialog-centered bv-modal-dialog">
        <div class="modal-content pv-modal-modern">
            ...
            <div class="pv-modal-body">
                ...
                {{-- Já recebeu boas-vindas: avisa antes de disparar de novo --}}
                <div class="bv-reenvio-alert d-none" id="bv-reenvio-alert">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 2v6h-6"/><path d="M3 12a9 9 0 0 1 15-6.7L21 8"/><path d="M3 22v-6h6"/><path d="M21 12a9 9 0 0 1-15 6.7L3 16"/>
                    </svg>
                    <span>Este contrato já recebeu boas-vindas <strong id="bv-reenvio-quando"></strong><span id="bv-reenvio-por"></span>. O envio abaixo entra no histórico como reenvio.</span>
                </div>
