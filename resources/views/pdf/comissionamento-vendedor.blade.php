...
<head>
  ...
  <style>
    ...
    /* Status de pagamento */
    .pay-status { margin-top: 4px; }
    .badge-paid { border:1px solid #16a34a; background:#ecfdf5; color:#166534; }
    .badge-pending { border:1px solid #b91c1c; background:#fff1f2; color:#b91c1c; }

    .pay-info{
      margin-top:4px; font-size:9px; color:#111827; text-align:right;
    }
    .pay-info div{ margin-top:2px; }
    .pay-label{ color:#6b7280; font-weight:400; }
    .pay-value{ font-weight:700; color:#111827; }
    ...
    /* 1: Data | 2: Contrato/Ajuste | 3: Operadora | 4: Base | 5: % | 6: Bruto | 7: Imposto | 8: Líquido | 9: Tipo */
...
<body>
  ...
  <div class="header">
    ...
    <div class="h-right">
      ...
      <!-- Flag de status do pagamento -->
      <div class="pay-status">
        @if (!empty($pagoEm))
          <span class="badge badge-paid">Pagamento realizado em {{ $pagoEm }}</span>
        @else
  ...
  <table>
    <thead>
      <tr>
        <th class="left">Data Implanta.</th>
