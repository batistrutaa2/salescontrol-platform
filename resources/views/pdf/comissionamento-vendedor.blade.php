...
<body>
    ...
    <div class="header">
        ...
        <div class="h-right">
            ...
            <!-- Dados de pagamento -->
            <div class="pay-info">
                <div><span class="pay-label">Agência/Conta:</span> <span
                        class="pay-value">{{ $agenciaConta ?? '0000 / 000000-0' }}</span></div>
                <div><span class="pay-label">Pix:</span> <span
                    ...
                    <td class="center">
                        @if ($isAdj)
                            ...
                            @if (str_contains($lbl, 'DÉBITO'))
                                <span class="badge"
                                    style="border-color:#b91c1c; background:#fff1f2; color:#b91c1c;">Ajuste
                                    (Débito)
                                </span>
                            @else
                                <span class="badge"
                                    style="border-color:#16a34a; background:#ecfdf5; color:#166534;">Ajuste
                                    (Crédito)</span>
                            @endif
                        @elseif($isAng)
                            <span class="badge"
                                style="border-color:#16a34a; background:#ecfdf5; color:#166534;">Angariação</span>
                        @else
