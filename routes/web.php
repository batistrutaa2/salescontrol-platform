...
use App\Http\Controllers\pages\manager\FunilController;
use App\Http\Controllers\pages\manager\IntegrationController;
...
Route::get('/login', [LoginBasic::class, 'index'])->name('login.form');
...
// O token opaco identifica a empresa sem expor um empresa_id enumerável.
Route::get('/tv-comercial/painel/{token}', [\App\Http\Controllers\TvComercialController::class, 'painelTv'])->name('tv-comercial.painel');
Route::get('/tv-comercial/dados/{token}', [\App\Http\Controllers\TvComercialController::class, 'getDadosTv'])->name('tv-comercial.dados');
Route::get('/tv-comercial/ranking/{token}', [\App\Http\Controllers\TvComercialController::class, 'getRankingTv'])->name('tv-comercial.ranking');

Route::middleware(['auth'])->group(function () {

    /** MANAGER */
    Route::post('manager/change-company', [Manager::class, 'changeCompany'])
    ...
    /** PAGINA INICIAL */
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
    ...
    Route::middleware('platform.admin')->group(function () {
        ...
        Route::get('/configuracoes/integracoes', [IntegrationController::class, 'index'])->name('manager.integrations.index');
        Route::put('/configuracoes/integracoes/voip', [IntegrationController::class, 'saveVoip'])->name('manager.integrations.voip.save');
        Route::delete('/configuracoes/integracoes/voip', [IntegrationController::class, 'deleteVoip'])->name('manager.integrations.voip.delete');
    });

    /** TV COMERCIAL - GERENCIAMENTO DE METAS */
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::SUPERVISOR)->group(function () {
        ...
        Route::post('/tv-comercial/configuracao', [\App\Http\Controllers\TvComercialController::class, 'atualizarConfiguracao'])->name('tv-comercial.atualizar-configuracao');
        ...
        Route::post('/tv-comercial/regenerar-acesso', [\App\Http\Controllers\TvComercialController::class, 'regenerarAcesso'])->name('tv-comercial.regenerar-acesso');
        Route::redirect('/ranking', '/tv-comercial/gerenciar')->name('ranking.index');
        Route::redirect('/ranking/configuracao', '/tv-comercial/gerenciar')->name('ranking.config');
        Route::get('/ranking/configuracao/edit/{id}', fn () => redirect()->route('tv-comercial.gerenciar'))
            ->whereNumber('id')
            ->name('ranking.edit');
    });
    ...
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
        ...
        Route::post('/usuarios/{user}/contas/salvar', [Usuarios::class, 'save'])->name('contasPagamento.save');

        Route::get('/configuracoes/funis', [FunilController::class, 'index'])->name('manager.funis.index');
        Route::post('/configuracoes/funis', [FunilController::class, 'store'])->name('manager.funis.store');
        Route::put('/configuracoes/funis/{tabulacao}', [FunilController::class, 'update'])->name('manager.funis.update');
        Route::patch('/configuracoes/funis/{tabulacao}/ordem', [FunilController::class, 'move'])->name('manager.funis.move');
    });
    ...
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
        ...
        Route::delete('/mailing/excluir-lead/{id}', [Mailing::class, 'deleteMailing'])->name('mailing.deleteMailing');
    ...
    /** COMERCIAL */
    Route::middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
        ...
        Route::patch('/comercial/demandas/configuracao', [Comercial::class, 'updateDemandSettings'])
            ->middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER)
            ->name('demandas.settings.update');
        ...
        Route::middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
            Route::get('/comercial/calendario-reunioes', [ReunioesComercial::class, 'index'])->name('comercialReunioes.index');
            Route::get('/reunioes/data', [ReunioesComercial::class, 'getReunioes'])->name('comercialReunioes.data');
            Route::get('/reunioes/stats', [ReunioesComercial::class, 'getStats'])->name('comercialReunioes.stats');
            Route::get('/reunioes/seller-contacts', [ReunioesComercial::class, 'getSellerContacts'])->name('comercialReunioes.contacts');
            Route::post('/reunioes', [ReunioesComercial::class, 'store'])->name('comercialReunioes.store');
            Route::put('/reunioes/{id}', [ReunioesComercial::class, 'update'])->name('comercialReunioes.update');
            Route::delete('/reunioes/{id}', [ReunioesComercial::class, 'destroy'])->name('comercialReunioes.destroy');
            Route::get('/available-slots/{managerId}/{date}', [ReunioesComercial::class, 'getAvailableSlots'])->name('comercialReunioes.slots');
        });
        Route::put('/configuracoes/reunioes', [ReunioesComercial::class, 'updateSettings'])
            ->middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER)
            ->name('comercialReunioes.settings.update');
    });
    ...
    /** BACKOFFICE */
    // O vendedor usa esta rota somente para ser redirecionado à correção do próprio estorno.
    Route::get(uri: '/back-office/abrir-contrato/{idContrato}', action: [Backoffice::class, 'openContract'])
        ->middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)
        ->name(name: 'backoffice.openContract');

    // ADVOGADA entra neste bloco somente para as rotas `backoffice.liminar.*`.
    // EnsureAdvogadaScope bloqueia/redireciona todas as demais rotas do sistema.
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::ADVOGADA)->group(function () {
        ...
        Route::delete(uri: '/back-office/deletar-contrato/{id}', action: [Backoffice::class, 'deleteContract'])->name('backoffice.deleteContract');
        ...
        Route::patch('/back-office/operadoras/{id}/regras-comerciais', [Backoffice::class, 'updateOperadoraRegrasComerciais'])->name('backoffice.operadoras.updateRegrasComerciais');
        ...
        Route::get('/back-office/estornos', [Backoffice::class, 'listaEstornos'])->name('backoffice.listaEstornos');
        Route::post('/back-office/retomar-estorno', [Backoffice::class, 'retomarEstorno'])->name('backoffice.retomarEstorno');
        ...
        Route::patch('/back-office/solicitacoes/{id}/atualizacoes/{historicoId}', [CentralSolicitacoesController::class, 'updateAtualizacao'])->whereNumber(['id', 'historicoId'])->name('backoffice.solicitacoes.atualizacoes.update');
        Route::delete('/back-office/solicitacoes/{id}/atualizacoes/{historicoId}', [CentralSolicitacoesController::class, 'destroyAtualizacao'])->whereNumber(['id', 'historicoId'])->name('backoffice.solicitacoes.atualizacoes.destroy');
        ...
        Route::patch('/back-office/pos-venda/configuracao', [Backoffice::class, 'updatePosVendaSettings'])->name('backoffice.posVenda.settings');
        ...
        Route::get('/back-office/credenciais/importar/modelo', [CredenciaisAcessoController::class, 'downloadModelo'])->name('backoffice.credenciais.import.modelo');
    ...
    Route::get('/comercial/faqs', [Comercial::class, 'faqsVendedor'])
        ->middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)
        ->name('comercial.faqs');
    ...
    Route::middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
        ...
        Route::get('/vendas/historico/{vendaId}', [Backoffice::class, 'getHistorico'])->name('sale.history');
    ...
    Route::post('/pabx/clickToCall', [Pabx::class, 'clickToCall'])
        ->middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)
        ->name('pabx.clickToCall');

    /** RELATORIOS */
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::SUPERVISOR)->group(function () {
    ...
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::BACKOFFICE)->group(function () {
    ...
    Route::middleware('role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::SUPERVISOR.','.\App\Enums\UserRole::DEVELOPER)->group(function () {
        ...
        Route::get('/estudos/{id}', [Estudo::class, 'show'])->name('estudo.data');
        Route::put('/estudos/{id}', [Estudo::class, 'update'])->name('estudo.update');
        ...
        Route::post('/estudos', [Estudo::class, 'store'])->name('estudo.store');
        Route::delete('/estudo-delete/{id}', [Estudo::class, 'delete'])->name('estudo.delete');
    });
    ...
    Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::FINANCEIRO)->group(function () {
        ...
        Route::prefix('financeiro/recebiveis')->group(function () {
            ...
            Route::patch('/relatorio-financeiro/configuracao', [Financeiro::class, 'atualizarConfiguracaoRelatorio'])
                ->name('financeiro.relatorio.configuracao');
        });
    });
    ...
    Route::prefix('escola')->name('escola.')->group(function () {
        ...
        // Área administrativa (ADMINISTRATIVO e DEVELOPER)
        Route::middleware('role:'.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::DEVELOPER)
            ->prefix('gestao')->name('gestao.')->group(function () {
                Route::get('/', [EscolaAdminController::class, 'index'])->name('index');
                Route::put('/configuracoes', [EscolaAdminController::class, 'updateConfiguracoes'])->name('configuracoes.update');
...
Route::middleware([
    'auth',
    'role:'.\App\Enums\UserRole::VENDEDOR.','.\App\Enums\UserRole::ADMINISTRATIVO.','.\App\Enums\UserRole::BACKOFFICE.','.\App\Enums\UserRole::DEVELOPER.','.\App\Enums\UserRole::SUPERVISOR,
    'throttle:60,1',
])->group(function () {
